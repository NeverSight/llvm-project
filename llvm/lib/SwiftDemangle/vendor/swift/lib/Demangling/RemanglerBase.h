...
protected:
  ...
  llvm::swift_demangle_detail::UnorderedMap<SubstitutionEntry, unsigned, SubstitutionEntry::Hasher>
...
public:
  ...
  std::string str() {
    return llvm::swift_demangle_detail::copyString(std::string_view(getBufferStr()));
  }
};
