...
Value *CodeGenFunction::EmitAArch64BuiltinExpr(unsigned BuiltinID,
  ...
  if (BuiltinID == clang::AArch64::BI__builtin_arm_ldclr ||
      BuiltinID == clang::AArch64::BI__builtin_arm_ldeor ||
      BuiltinID == clang::AArch64::BI__builtin_arm_ldset ||
      BuiltinID == clang::AArch64::BI__builtin_arm_ldsmax ||
      BuiltinID == clang::AArch64::BI__builtin_arm_ldsmin ||
      BuiltinID == clang::AArch64::BI__builtin_arm_ldumax ||
      BuiltinID == clang::AArch64::BI__builtin_arm_ldumin) {
    ...
    llvm::Value *Pointer = EmitScalarExpr(E->getArg(1));
    Address Dest(Pointer, ValueTy, CharUnits::fromQuantity(Bytes));
    llvm::AtomicRMWInst::BinOp AtomicOp = llvm::AtomicRMWInst::And;
    if (BuiltinID == clang::AArch64::BI__builtin_arm_ldeor)
      AtomicOp = llvm::AtomicRMWInst::Xor;
    else if (BuiltinID == clang::AArch64::BI__builtin_arm_ldset)
      AtomicOp = llvm::AtomicRMWInst::Or;
    else if (BuiltinID == clang::AArch64::BI__builtin_arm_ldsmax)
      AtomicOp = llvm::AtomicRMWInst::Max;
    else if (BuiltinID == clang::AArch64::BI__builtin_arm_ldsmin)
      AtomicOp = llvm::AtomicRMWInst::Min;
    else if (BuiltinID == clang::AArch64::BI__builtin_arm_ldumax)
      AtomicOp = llvm::AtomicRMWInst::UMax;
    else if (BuiltinID == clang::AArch64::BI__builtin_arm_ldumin)
